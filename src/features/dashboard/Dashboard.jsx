...
export default function Dashboard() {
  const { athletes, tickets, exportAthletesCsv, exportTicketsCsv } = useAppContext();
        ...
        <div className="admin-tables">
          ...
          <div className="admin-table-card">
            <div className="admin-table-header">
              ...
              <button className="btn subtle" onClick={exportAthletesCsv}>Export to Excel</button>
            </div>
          ...
          <div className="admin-table-card">
            <div className="admin-table-header">
              ...
              <button className="btn subtle" onClick={exportTicketsCsv}>Export to Excel</button>
            </div>
            <div className="table-wrapper">
              <table>
                <thead>
